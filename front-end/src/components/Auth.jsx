...
const Auth = ({setId}) => {
  ...
  return (
    <div className={`flex h-[100vh] w-full  flex-col flex-wrap justify-center items-center text-black bg-gradient-to-r from-blue-600 to-violet-600 `} >
        <div className='w-[50%]'>
            ...
            <div className='flex flex-wrap justify-between mt-6' >
                <button 
                onClick={handleLogin}
                className='px-4 py-2 bg-gray-800 text-white'>Login
                </button>
                <button 
                onClick={handleCreateId}
                className='px-4 py-2 bg-black text-white'>Create new ID
                </button>
            </div>
        </div>
    </div>
